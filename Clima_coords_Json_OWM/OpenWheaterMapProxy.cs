...
//
//    using Clima_coords_Json_OWM;
//
//    var openWheaterMapProxy = OpenWheaterMapProxy.FromJson(jsonString);
...
namespace Clima_coords_Json_OWM
{
    ...
    public partial class OpenWheaterMapProxy
    {
        public static OpenWheaterMapProxy FromJson(string json) => JsonConvert.DeserializeObject<OpenWheaterMapProxy>(json, Clima_coords_Json_OWM.Converter.Settings);
    }
